...
| Requirement | My Results | Required Results |
| ----------- | ---------- | ---------------- |
| A `groupby` or `pivot_table` function has been used to create a multi-index DataFrame with the "region", "state", and "city" columns. | | ![Screenshot 2024-06-17 at 10 52 08 AM](https://github.com/brian-campbell/athletic_sales_analysis/assets/798207/32fe52a4-a20c-46da-8d21-df2a661e2dea) ![Screenshot 2024-06-17 at 10 52 40 AM](https://github.com/brian-campbell/athletic_sales_analysis/assets/798207/80566a73-d5ab-4a1d-a5c8-4588ccac9545) |
